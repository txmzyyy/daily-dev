...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Save selected role locally for onboarding
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-white font-semibold py-3 rounded-xl text-sm transition shadow-lg shadow-indigo-600/20"
          >
        ...
        <div className="relative text-center my-4">
          ...
          <span className="relative bg-[#09090b] px-3 text-xs text-zinc-500">
            or continue with
          </span>
        </div>
